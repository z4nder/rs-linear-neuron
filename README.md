...
- 1 [Prólogo](#1)
- 2 [O problema](#2)
- 3 [O que é um dataset](#3)
- 4 [A fórmula: y = mx + b](#4)
- 5 [Implementando o neurônio](#5)
- 6 [Calculando o erro](#6)
- 7 [Desenvolvendo o training loop](#7)
- 8 [As limitações desse método](#8)
- 9 [Conclusão](#9)
...
Tenho usado muita IA ultimamente para escrever código, construir produtos e acompanhar tudo o que está acontecendo na área. Um ponto com o qual sempre concordo é a importância de **estudar os fundamentos**.
...
### 3. O que é um dataset <a name="3"></a>
...
### 5. Implementando o neurônio <a name="5"></a>
...
### 6. Calculando o erro <a name="6"></a>
...
### 7. Desenvolvendo o training loop <a name="7"></a>
...
### 8. As limitações desse método <a name="8"></a>
...
Se este post fizer sentido pra você, o próximo passo natural é implementar uma função de perda e depois partir para **gradient descent**, que é onde o treino começa a ficar mais próximo do que se usa de verdade em Machine Learning.
